...
void DNSClient2::begin(const IP6Address& aDNSServer)
{
...
int DNSClient2::inet_aton(const char* address, IP6Address& result)
{
...
int DNSClient2::getHostByName(const char* aHostname, IP6Address& aResult, uint16_t timeout)
{
	int ret = 0;
...
uint16_t DNSClient2::BuildRequest(const char* aName)
{
	// Build header
	//                                    1  1  1  1  1  1
...
uint16_t DNSClient2::ProcessResponse(uint16_t aTimeout, IP6Address& aAddress)
{
